...
//        BL_FEEDER = hardwareMap.get(Servo.class, "bl_feeder");*/
    ...
    public void upFR() { FR_FEEDER.setPosition(0.77); } // 0.83
    public void downFR() { FR_FEEDER.setPosition(0.54); }

    public void upBL() { BL_FEEDER.setPosition(0.56); } // 0.77
    public void downBL() { BL_FEEDER.setPosition(0.27); } // 0.55
