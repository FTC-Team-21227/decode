...
@Autonomous(name = "Blue_Far_9_Human_Better")
public class Auto_Far_Blue_Goal_6_Human_2 extends LinearOpMode {
    @Override
...
//        Pose2d initialPose = new Pose2d(-55, 46, Math.toRadians(-55));
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(56,-12,Math.toRadians(-120)))
                ...
                ;
        TrajectoryActionBuilder tab2_back = drive.actionBuilder(new Pose2d(/*37*/ 62,-60,Math.toRadians(-90))) //first specimen
        ...
        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(56,-12,Math.toRadians(-120)))
                ...
                .strafeTo(new Vector2d(56,-56))
                ;
        TrajectoryActionBuilder tab3_back = drive.actionBuilder(new Pose2d(/*37*/ 62,-60,Math.toRadians(-90))) //first specimen
                .strafeToLinearHeading(new Vector2d(56,-12),Math.toRadians(-120))
                ;
