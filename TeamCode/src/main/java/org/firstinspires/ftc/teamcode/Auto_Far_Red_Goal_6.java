...
//        Pose2d initialPose = new Pose2d(-55, 46, Math.toRadians(-55));
        Pose2d initialPose = new Pose2d(62.7, 10, Math.toRadians(180));
        ...
        TrajectoryActionBuilder tab2 = drive.actionBuilder(new Pose2d(56,12,Math.toRadians(120))) //first specimen
                ...
                ;
        TrajectoryActionBuilder tab2_back = drive.actionBuilder(new Pose2d(37,56,Math.toRadians(90))) //first specimen
            ...
            Actions.runBlocking(
                    new ParallelAction(
                            ...
                            telemetryPacket -> {
                                ...
                                robot.updateShooter(shotReqFR.get(), shotReqBL.get(), false, telemetry, true, Robot.Positions.autoShotPose_Far, 0, false, false, false, false, false);
...
//                            robot.camera.detectObelisk(telemetry, true);
            ...
            Action secondShot = Robot.shootSequence(shotReqFR, shotReqBL, slowIntake, new char[]{'G', 'P', 'P'}, i, 2);
...
//                            id.set(robot.camera.detectObelisk(telemetry, detectOb.get()));
            ...
            Robot.Constants.flywheelPower = 2.4;
